			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form class="form-horizontal" method="post" action="<?php echo U('System/editrole',array('id'=>$detail['id']));?>" name="basic_validate" id="signupForm">
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div class="radio i-checks">
										<?php if($detail['status'] == 1 ): ?><label>
												<input type="radio" name='data[status]' value="1" checked="checked" />启用</label>
											<label>
												<input type="radio" name='data[status]' value="0" />停用</label><?php endif; ?>
										<?php if($detail['status'] == 0 ): ?><label>
												<input type="radio" name='data[status]' value="1" />启用</label>
											<label>
												<input type="radio" name='data[status]' value="0" checked="checked" />停用</label><?php endif; ?>
									</div>
								</div>
							</div>
							<div class="hr-line-dashed"></div>
