...
$(document).ready(function(){
	$("#loginout").click(function(){
						...
						<table class="table table-bordered">
							...
							<tbody>
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="long-td">										
										...
										<td><img src="/Uploads/<?php echo ($vo["photo"]); ?>" onerror="this.src='/Public/Admin/img/no_img.jpg'" style="height: 60px" /></td>
		...
		function del(id,p){
			...
			layer.close(index);
			window.location.href="/Admin/Article/del/a_id/"+id+"/p/"+p+"";
			});
		}
		</script>
