						...
						<ul class="list-group">
							<li class="list-group-item">
								<p class="text-success"><a href="<?php echo U('Index/index');?>" title="返回首页" class="tip-bottom"><i class="fa fa-home"></i> 首页</a> /
									...
									<a href="<?php echo U('News/index');?>" class="tip-bottom">编辑管理</a> /
									<a href="#" class="tip-bottom">编辑新闻</a>
								</p>
							</li>
						</ul>
					</div>
			...
			<div class="col-sm-12">
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						<form class="form-horizontal" method="post" action="<?php echo U('News/edit',array('id'=>$detail['id']));?>" name="basic_validate" id="signupForm">
							<div class="form-group">
								<label class="col-sm-2 control-label">标题</label>
								<div class="col-sm-6">
									<input type="text" name="title" id="title" value="<?php echo ((isset($detail["title"]) && ($detail["title"] !== ""))?($detail["title"]):''); ?>"  placeholder="输入新闻标题" class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
				                ...
				                <div class="col-sm-6">                   
				                    <select name="cate_id"  class="form-control m-b chosen-select">
                                        <?php if(is_array($list2)): $i = 0; $__LIST__ = $list2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if(($vo["id"]) == $detail["cate_id"]): ?>selected="selected"<?php endif; ?>><?php echo ($vo["catename"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                    </select>
				                </div>
				            </div>
				            <div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="keyword" id="keyword" value="<?php echo ((isset($detail["keyword"]) && ($detail["keyword"] !== ""))?($detail["keyword"]):''); ?>" placeholder="输入关键字" class="form-control">
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div style="width: 200px; height: 110px; float: left;">
										<input type="hidden" name="data[image_url]" value="<?php echo ((isset($detail["image_url"]) && ($detail["image_url"] !== ""))?($detail["image_url"]):''); ?>" id="data_photo" />
										<input id="photo_file" name="photo_file" type="file" multiple="true" value="" />
									</div>
									<div style="width: 200px; height: 110px; float: left;">
										<img id="upload_img" src="/Uploads/<?php echo ((isset($detail["image_url"]) && ($detail["image_url"] !== ""))?($detail["image_url"]):'default.jpg'); ?>" style="width: 100px;height: 100px" />
									</div>
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <script type="text/plain" id="editor" name="info" style="width:78%;height:300px;"><?php echo (stripslashes(htmlspecialchars_decode($detail["info"]))); ?></script>
                                </div>
                            </div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
								<div class="col-sm-4 col-sm-offset-2">
									...
									<a class="btn btn-white" href="<?php echo U('System/userlist');?>">取消</a>
								</div>
							</div>
						</form>
					</div>
