					...
					<div class="ibox-content">
						<form class="form-horizontal" method="post" action="<?php echo U('System/adduser');?>" name="basic_validate" id="signupForm">
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" name="user" id="user" placeholder="输入用户名" class="form-control">
								</div>
							</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-6">
									<input type="text" id="username" name="username" placeholder="输入显示名称" class="form-control">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-6">
									<div style="width: 200px; height: 90px; float: left;">
										<input type="hidden" name="userimg" value="" id="data_photo" />
										<input id="photo_file" name="photo_file" type="file" multiple="true" value="" />
									</div>
									<div style="width: 200px; height: 90px; float: left;">
										<img id="upload_img" class="img-circle" src="/Uploads/<?php echo ((isset($detail["userimg"]) && ($detail["userimg"] !== ""))?($detail["userimg"]):'touxiang_default.gif'); ?>" style="width: 80px;height: 80px" />
									</div>
								</div>
							</div>
							<div class="hr-line-dashed"></div>
							<div class="form-group">
				                ...
				                <div class="col-sm-6">                   
				                    <select name = "data[role]" class="form-control m-b chosen-select">
				                      <?php if(is_array($list)): foreach($list as $key=>$var): ?><option value="<?php echo ($var["id"]); ?>"><?php echo ($var["name"]); ?></option><?php endforeach; endif; ?>                  
				                    </select>
				                </div>
				            </div>
							<div class="hr-line-dashed"></div>
							...
							<div class="form-group">
								...
								<div class="radio i-checks">
										<label>
											<input type="radio" checked="checked" value="1" name="data[state]"> <i></i> 正常</label>
											<label>
											<input type="radio" value="0" name="data[state]"> <i></i> 停用</label>
									</div>																	
								</div>
							</div>
							<div class="hr-line-dashed"></div>
