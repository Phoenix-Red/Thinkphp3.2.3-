...
<link rel="stylesheet" type="text/css" href="/Statics/Error/css/dandelion.css"  media="screen" />
<title>404错误页面</title>
</head>
<body>
            ...
            <div class="da-container clearfix">          
            	<div id="da-error-wrapper">              	
                    ...
                    <div id="da-error-code">
                    	Warning<span>666</span>
                    </div>               
                	<h1 class="da-error-heading">哎哟喂,作品集正在维护中,敬请期待哟.... </h1>
                    <p><a href="<?php echo U('Index/index');?>">点击进入首页</a></p>
                </div>
            </div>
        </div>             
    </div>   
