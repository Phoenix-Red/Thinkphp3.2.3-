...
<link rel="stylesheet" type="text/css" href="/Public/Home/email/completer.css"/>         
<script src="/Public/Home/email/completer.min.js"></script>
<script type="text/javascript">
    $(function() {
        $("#email").completer({
            separator: "@",
						...
						<div class="xs12">
							<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="clearfix articlebox">
									...
									<?php if($vo["c_content"] != ''): ?><div class="f_liuyan">
										...
										<div class="said_img">
											<img src="/Uploads/<?php echo ($vo['c_photo']); ?>" class="radius-circle" width="60px" height="60px" />
											<div class="liuyan_t">
										...
										<form action="<?php echo U('Home/liuyan/addContent');?>" name="signupForm" id="signupForm" method="post" class="form form-block">							
											<div class="form-group">
												<div class="field">
													...
													<input type="text" class="input" id="username" name="username" value="<?php echo ($qqname); ?>" readonly="readonly" placeholder="请输入昵称" />
												</div>
												</div>
											</div>
											<div class="form-group">
